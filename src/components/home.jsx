...
const slides = [
  {
    ...
    title: "Italian",
    image:
      "https://images.unsplash.com/photo-1561350111-7daa4f284bc6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80",
  },
  {
    subTitle: "Pasta",
    title: "Italian",
    image:
      "https://c0.wallpaperflare.com/preview/124/905/130/bowl-chopsticks-close-up-cuisine.jpg",
  },
  {
    subTitle: "Awesome",
    title: "Fork",
    image:
      "https://c1.wallpaperflare.com/preview/714/652/925/spaghetti-pasta-noodles-italian.jpg",
  },
  {
    subTitle: "Pizza",
    title: "Italian",
  ...
  },
  {
    ...
    title: "Pepper",
    image:
      "https://c4.wallpaperflare.com/wallpaper/501/768/988/fire-food-chilli-peppers-wallpaper-preview.jpg",
  },
];
    ...
    <section className="home-route">
      ...
      <div className="home-special">
        ...
        <div className="special-text">
          <h1 className="special-title title">Why we are special ..?</h1>

          <p className="special-description paragraph">
            Our resturant presents for you all pizza types all your needs, but
            we are special because we are the first resturant that can serve for
            you the best pizza and pasta with your adorable sauce PESTO sauce.
      ...
      <div className="home-pesto">
        ...
        <div className="pesto-desc">
          <div className="desc paragraph">
            <p className="desc-1">
              Originally from Genoa, Italy, pesto traces its name to the Italian
              word "pestare," which means "to crush or pound." For hundreds of
              years, pesto was made by pounding the ingredients in a mortar and
              pestle. It dates back from Roman times when Genoans would crush
              walnuts with herbs and garlic. Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Ut laboriosam doloribus dolorum quod
              expedita in commodi, itaque quas odit aperiam possimus non nam
              eius quasi laudantium voluptas iure vel! Distinctio! Lorem, ipsum
              dolor sit amet consectetur adipisicing elit. Itaque obcaecati
              similique eos consectetur neque, repudiandae nobis aperiam rerum
              et consequatur vitae corrupti voluptatum nam delectus! Laboriosam
              assumenda necessitatibus magnam perspiciatis!
            </p>
            <p className="desc-2">
              The most popular variety of pesto now is made by "crushing" basil,
              garlic, pine nuts, olive oil and some hard cheese in a food
              processor or blender. It's fun to use a mortar and pestle, but the
              modern way is much easier. Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Corrupti deserunt consequuntur tempora, dolores
              beatae sunt praesentium reiciendis sed quaerat eaque blanditiis
              omnis ducimus dolorum nulla. Eaque aspernatur reprehenderit quia
              porro!
            </p>
          </div>
      ...
      <div className="home-subscription">
        <div className="subscription-wrapper">
          <div className="subscription-section">
            <h1 className="subscription-title title">Subscribe Now</h1>
